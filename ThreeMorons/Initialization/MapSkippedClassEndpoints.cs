...
namespace ThreeMorons.Initialization
{
    public static partial class Initializer
    {
        public static void MapSkippedClassEndpoints(WebApplication app)
        {
            ...
            SkippedClassGroup.MapGet("/forGroup", async ([FromQuery(Name = "groupName")] string groupName, ThreeMoronsContext db) =>  //https://api.../skippedClass/forGroup/?groupName=ис-44К
            {
